                ...
                {getCurrentPageData().map((job) => (
                    <JobCard key={job.id} style={{ display: 'flex' }} onClick={() => navigate("/jobdetails")}>
                        ...
                        <div>
                            ...
                            <div>
                                <ApplyButton style={{ marginTop: 'auto', marginBottom: '10px', padding: '10px 20px' }}>Nộp đơn</ApplyButton>
                            </div>
